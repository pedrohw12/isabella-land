    ...
    <>
      ...
      >
        ...
        <Box sx={{ width: "70%", maxWidth: "lg" }}>
          ...
          >
            Aqui você encontrará{!isSmallScreen && <br />} o real sentido da
            vida
          </Typography>
          <Typography
            variant="h5"
          ...
          >
            Ajudando mulheres há mais de X anos a{!isSmallScreen && <br />}{" "}
            encontrarem o real sentido da vida
          </Typography>
          <Button
